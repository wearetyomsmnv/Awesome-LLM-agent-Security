...
| [Armorer Guard](https://github.com/ArmorerLabs/Armorer-Guard) | Runtime Security Tool | Local Rust scanner and MCP proxy for AI agents | - Prompt injection detection<br>- Credential redaction<br>- Exfiltration and dangerous tool-call checks<br>- Structured JSON reasons and local learning overlay |
